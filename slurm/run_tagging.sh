...
do
    ...
    CUDA_VISIBLE_DEVICES=0 python src/predict.py ${cfg_file} cfg/downstream/tagging.gin

    CUDA_VISIBLE_DEVICES=0 python src/downstream.py ${id} cfg/downstream/tagging.gin
done
