...
do
    ...
    CUDA_VISIBLE_DEVICES=0 python src/predict.py ${cfg_file} cfg/downstream/beattracking.gin

    # CUDA_VISIBLE_DEVICES=1 python src/downstream.py ${id} cfg/downstream/beattracking.gin
done
