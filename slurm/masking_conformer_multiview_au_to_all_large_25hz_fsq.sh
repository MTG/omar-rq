...
# interrupt and resubmit 90 seconds before training ends (experimental)
...
srun python3 src/train.py cfg/config_masking_conformer_multiview_au_to_all_large_25hz_fsq.gin
